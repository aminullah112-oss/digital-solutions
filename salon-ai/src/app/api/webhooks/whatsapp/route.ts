...
import { WhatsAppAdapter } from "@/lib/channels/adapters";
import { ingestChannelMessage } from "@/lib/ai/ingest";

// Meta webhook verification handshake (GET) — required once when registering the webhook URL.
...
export async function POST(req: NextRequest) {
  ...
  const messages = WhatsAppAdapter.parse(payload);
