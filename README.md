...
sheetmetal-pipeline/   Unrelated project living in the same repo — not part of
                       this site
abirami-sree-hardwares/  Client site for Abirami Sree Hardware & Kaveen's
                       Construction (Thiruporur) — a standalone static
                       HTML/CSS/JS site, unrelated to the portfolio app above.
                       No build step; edit index.html/css/js directly.
```
